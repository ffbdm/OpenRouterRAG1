...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen max-w-3xl mx-auto p-6">
      <header className="border-b pb-4 mb-6">
        ...
        <p className="text-xs text-muted-foreground mt-3 bg-muted p-2 rounded">
          💡 Dica: Abra o Console (F12) para ver logs detalhados de quando dados estão sendo consultados no banco de dados PostgreSQL
        </p>
      </header>
      ...
      <form
        ...
        className="sticky bottom-0 border-t pt-4 backdrop-blur-sm bg-background/80"
      >

...
> Quero ter dois instructions (role: system) no sistema. O primeiro para explicar como a IA ira fazer a busca, quais functions possui e como trazer os dados. A segunda é para explicar como entregar os dados recebidos, tratar e enviar para o usuario (de forma estruturada)
